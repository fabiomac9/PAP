        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="list-group py-4">
                    ...
                    ?>
                        <a style="color: black;" href="?cmd=produtos&filtro=<?= $value->id ?>" class="list-group-item"><?= $value->type ?></a>
                    <?php
                    }
                    /*$brands = array();
            ...
            <div class="center_column col-xs-12 col-sm-9 text-center">
                    ...
                    ?>
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">
                                        <a style="color: black;" href="?cmd=products&id=<?= $value->id?>"><?= $value->name ?></a>
                                    </h4>
                                    <a style="color: #b80e1f;font-size: 20px" href="?cmd=products&id=<?= $value->id?>"><?= $value->price ?>€</a>
                                    <?php
                                    if (isset($_SESSION['type'])) {
                                    ?>
                                        <h5><a style="color: black;" href="#" data-name="<?= $value->name ?>" data-price="<?= $value->price ?>" class="add-to-cart text-primary">Adicionar ao carrinho</a></h5>
                                    <?php
                                    }
                                    ?>
                                </div>
                ...
                ?>
                    <a style="color: black;font-size:20px;" href="index.php?cmd=produtos&pag=<?= $i ?>"><?= $i ?></a>
                <?php
                }
                ?>
            </div>
